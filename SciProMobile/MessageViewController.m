...
- (void)updateView{
    ...
    if (inbox) {
        urlBasic = [NSMutableString stringWithString: @"http://localhost:8080/SciPro/json/message?userid="];
    }else
        urlBasic = [NSMutableString stringWithString: @"http://localhost:8080/SciPro/json/message/sentmessages?userid="];
...
- (void)setRead: (NSNumber*) recipientId{
    ...
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString: @"http://localhost:8080/SciPro/json/message/setread"]];
...
- (void)deleteMessage: (NSNumber*) recipientId{
    ...
    NSMutableString *urlBasic;
    if (inbox) {
        urlBasic = [NSMutableString stringWithString: @"http://localhost:8080/SciPro/json/message/deleterecipient"];
    }else
        urlBasic = [NSMutableString stringWithString: @"http://localhost:8080/SciPro/json/message/deleteprivatemessage"];

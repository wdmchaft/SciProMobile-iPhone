...
- (void)updateView{
    ...
    NSMutableString *url = [NSMutableString stringWithString:@"http://localhost:8080/SciPro/json/status?userid="];
...
- (void)setStatus{      
    ...
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString: @"http://localhost:8080/SciPro/json/setstatus"]];
